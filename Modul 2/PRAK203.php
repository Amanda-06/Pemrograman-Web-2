...
<body>
    <form action="" method="POST">
        ...
        Ke : <br>
        <input type="radio" name="suhuTujuan" value="°C">Celcius<br>
        <input type="radio" name="suhuTujuan" value="°F">Fahrenheit<br>
        <input type="radio" name="suhuTujuan" value="°R">Rheamur<br>
        <input type="radio" name="suhuTujuan" value="°K">Kelvin<br>
...
<?php
    ...
    if(isset($_POST["konversi"])){
        if(empty($_POST["nilai"]) || !isset($_POST["suhuAwal"]) || !isset($_POST["suhuTujuan"])){
            echo "<i>Harap isi nilai dan pilih jenis suhu!</i>";
        } else {
            ...
            echo "<h2>Hasil Konversi: $hasilKonversi $ke</h2>";
        }
    }
?>